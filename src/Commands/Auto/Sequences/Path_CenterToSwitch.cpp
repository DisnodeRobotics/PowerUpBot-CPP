#include "Path_CenterToSwitch.h"
#include "Robot.h"
#include "RoboMap.h"

using namespace std;
Path_CenterToSwitch::Path_CenterToSwitch()
{
...
void Path_CenterToSwitch::Initialize()
{
	RoboMap::navX->Reset();
...
void Path_CenterToSwitch::Execute()
{
...
bool Path_CenterToSwitch::IsFinished()
{
	return leftFollower.finished &&  rightFollower.finished;
}

void Path_CenterToSwitch::End()
{
...
void Path_CenterToSwitch::Interrupted()
{
